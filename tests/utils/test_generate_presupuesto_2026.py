...
def test_build_end_to_end_small_fixture():
    ...
    sales = []
    for m in range(1, 13):
        sales.append(("095", "DANIEL", 2025, m, 100.0))
        sales.append(("060", "YULI", 2025, m, 50.0))
        sales.append((None, "AMELIA LEFT", 2025, m, 10.0))  # pool
    sales.append(("123", "WILLIAM HERNANDO QUINTERO G", 2026, 6, 5.0))
    coded = [
        ("095", "DANIEL", 1200.0),
        ("060", "YULI", 600.0),
